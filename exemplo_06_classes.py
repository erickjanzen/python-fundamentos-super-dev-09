...
class Tenis:
    def __init__(self, modelo: str, tamanho: float):
        self.modelo = modelo
        self.tamanho = tamanho

    def apresentar_dados(self):
        print(f"""Tênis: {self.modelo}
Tamanho: {self.tamanho}
""")
def exemplo_tenis():
    nike = Tenis("Nike Uptempo Marrom", 39)
    adidas = Tenis("Yeezy Foam Runner Cinza", 40)
    new_balance = Tenis("New Balance 530 Azul", 41)

    nike.apresentar_dados()
    adidas.apresentar_dados()
    new_balance.apresentar_dados() 
